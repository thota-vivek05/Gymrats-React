  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const workoutData = workoutResponse.ok
        ...
        : null;
      const nutritionData = nutritionResponse.ok
      ...
      setDashboardData((prev) => ({
        ...
        todayNutrition: nutritionData?.success
          ? nutritionData.todayNutrition
          : prev.todayNutrition,
        todaysConsumedFoods: nutritionData?.success
          ? nutritionData.todaysConsumedFoods
          : prev.todaysConsumedFoods,
        weeklyWorkouts: statsData?.success
          ? statsData.weeklyWorkouts
          : prev.weeklyWorkouts,
        exerciseProgress: progressData?.success
          ? progressData.exerciseProgress
          : prev.exerciseProgress,
        upcomingClass: classData?.success
      ...
      <div className="max-w-7xl mx-auto px-5 pb-10 overflow-x-hidden">
          ...
          {hasAccess("Platinum") ? (
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-5 flex flex-col items-center justify-center text-center h-full min-h-[300px]">
              ...
              <p className="text-sm text-gray-500 max-w-xs mx-auto">
                Upgrade to our Platinum plan to access live classes with
        ...
        {hasAccess("Gold") ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-8 text-center mt-10">
            <h3 className="text-xl font-bold text-gray-300 mb-2">
              Nutrition Tracking Locked
            </h3>
            <p className="text-sm text-gray-500">
              Upgrade to Gold or Platinum to unlock advanced nutrition tracking
              and meal logs.
            </p>
          </div>
        )}
