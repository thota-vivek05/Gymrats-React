...
const DashboardHeader = ({ user, currentPage }) => {
    ...
    const navLinkClasses = (page) => 
        `text-gray-300 hover:text-[#8A2BE2] transition-colors ${currentPage === page ? 'text-[#8A2BE2] font-semibold' : ''}`;
        ...
        <div className="bg-black/90 sticky top-0 z-40 border-b border-gray-800 backdrop-blur-sm">
            <header className="flex justify-between items-center h-16 px-5 max-w-7xl mx-auto">
                <div className="flex-shrink-0">
                    <Link to={getDashboardPath()} className="text-2xl font-bold text-[#8A2BE2] tracking-wider">
                        GymRats
                    </Link>
                </div>
                ...
                <div className="hidden md:flex gap-8 items-center">
                    <Link to={getDashboardPath()} className={navLinkClasses('dashboard')}>Home</Link>
                    <Link to="/user_exercises" className={navLinkClasses('exercises')}>Exercises</Link>
                    <Link to="/user_nutrition" className={navLinkClasses('nutrition')}>Nutrition</Link>
                </div>
                ...
                >
                    <img src="/userdashboard/menu.jpg" alt="Menu" className="h-6 w-auto invert" />
                </div>
